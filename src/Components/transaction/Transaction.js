					...
					<>
						<div class="container-popup" ref={popUpContainer}>
							<div class="popup" id="popup" ref={popUp}>
								...
								<h2>Błąd</h2>
								<p>Foromularz dodawania transakcji jest niepoprawny. Popraw błędne pola.</p>
								<button type="button" onClick={()=>{popUp.current.classList.remove('open-popup'); popUpContainer.current.classList.remove('open-popup-window') }}>OK</button>
							</div>  
						</div>
							<section id="content">
							<main>
								...
								<div className="transactions">
									<div className="order">
										<div className="head">
											<h3>Histora</h3>
											<span>Sortuj po:</span>
											<select className="btn-select" ref={sortOptions} onChange={()=> force()}>
										...
										<table>
											<thead>
												<tr>
													<td colSpan={6} style={{fontWeight: 700, textAlign: "center"}}>Dodaj transakcje </td>
												</tr>
												<tr className="transaction-tr">
													...
													<th>
														<input type="date" ref={dateInput} value={setCurrentDate()} />
													</th>
													<th>
													...
													<th>
														<input type="text" placeholder="Podaj opis..." ref={descInput}/>
													</th>
													<th>
														<input type="number" placeholder="Podaj kwotę..." ref={costInput}/>
													</th>
											...
											<HistoryItem isActive={isActive} sortBy={sortOptions.current}/>
										</table>
									</div>
									</div>
							</main>
